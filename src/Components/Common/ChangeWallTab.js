...
import rightIcon from '../../assets/images/LeanToIcon/LeanToRightIcon.svg';
import leftIcon from '../../assets/images/LeanToIcon/LeanToLeftIcon.svg';
import frontIcon from '../../assets/images/LeanToIcon/LeanToFrontIcon.svg';
import NoneIcon from '../../assets/images/LeanToIcon/LeanToNoneIcon.svg';

const ChangeWallTab = ({sectionType,wallsContainingComp,walls,type}) => {
  ...
  return (
    <section className='mb-lean-container'>    
      <div className='pcol-12 p-0'>  
        <ul className='wall-tab-container mt-0'>
          {
            sectionType === "doorandwindow" ? (
              walls?.map((wall) => {
                let checkActive ;
                if(type == "centerbuilding") {
                ...
                return <li className={checkActive == wall.value  ? 'active' : wallsContainingComp.includes(wall.value) ?  'with-content': ''}>
                  ...
                  <div className='changeWallTabArrow'></div>
                  <div className='changeWallTabArrow'></div>
                  </a>    
                </li>
              })

...
export default class RightLeanToRoof extends Component {
    createRightLeanToRoof = (const_var, params) => {
        ...
        let rRoofGeometry1 = new THREE.BufferGeometry();
        ...
        let rtexture = rRoofloader.load(process.env.REACT_APP_BASE_URL+roofImg)
        ...
        // let rRoofmaterial = new THREE.MeshBasicMaterial({ map: rtexture, side:THREE.DoubleSide, color:0xB61202 });
        let rRoofmaterial = new THREE.MeshPhongMaterial({
        ...
        let rRoof = new THREE.Mesh(rRoofGeometry1, rRoofmaterial);
        rRoof.name = "rRoof";
        rRoof.visible = false;
        ...
        let cubeTRR = new THREE.Mesh(geometryT, materialT);
        cubeTRR.name = "leanToRegularRoofR";
        let rCalor1 = params.p_r_c.replace("#", "0x");
        cubeTRR.material.color.setHex(rCalor1);
        cubeTRR.visible = false;
        ...
        let rightLeanToFrontBow = new THREE.Mesh(bowGeometry, bowMaterial);
        ...
        rightLeanToFrontBow.visible = false;
        const_var.b_t_M_R_t_R.add(rightLeanToFrontBow);

        let rightLeanToFrontBowR = new THREE.Mesh(bowGeometry, bowMaterial);
        ...
        rightLeanToFrontBowR.visible = false;
        const_var.b_t_M_R_t_R.add(rightLeanToFrontBowR);


        let rightBowGeo1 = new THREE.BoxGeometry(0.075, 0.6 + 0.19, 0.2 + 0.1);
        // let rightBowBowMaterial1 = new THREE.MeshBasicMaterial({color:0xC9C6C6,side:THREE.DoubleSide});
        let leanToRightFrontBow1 = new THREE.Mesh(rightBowGeo1, bowMaterial);
        ...
        leanToRightFrontBow1.visible =  false;
        const_var.b_t_M_R_t_R.add(leanToRightFrontBow1);

        let rightBowGeo2 = new THREE.BoxGeometry(0.075, 0.6 + 0.18, 0.2 + 0.1);
        // let rightBowBowMaterial2 = new THREE.MeshBasicMaterial({color:0xC9C6C6,side:THREE.DoubleSide});
        let leanToRightFrontBow2 = new THREE.Mesh(rightBowGeo2, bowMaterial);
        ...
        leanToRightFrontBow2.visible =  false;
        const_var.b_t_M_R_t_R.add(leanToRightFrontBow2);

        let rightBowGeo3 = new THREE.BoxGeometry(0.25, 0.6 + 0.23, 0.2 + 0.1);
        // let rightBowBowMaterial3 = new THREE.MeshBasicMaterial({color:0xC9C6C6,side:THREE.DoubleSide,});
        let leanToRightFrontBow3 = new THREE.Mesh(rightBowGeo3, bowMaterial);
        leanToRightFrontBow3.name = "leanToRightFrontBow3";
        ...
        leanToRightFrontBow3.visible =  false;
        const_var.b_t_M_R_t_R.add(leanToRightFrontBow3);

        let rightLeanToFrontTrim = new THREE.Mesh(bowGeometry, trimMaterial);
        ...
        rightLeanToFrontTrim.visible = false;
        const_var.b_t_M_R_t_R.add(rightLeanToFrontTrim);


        let leanToRightFrontTrim1Geo = new THREE.BoxGeometry(0.07 + 0.007, 0.6 + 0.2, 0.2 + 0.1);
        let leanToRightFrontTrim1Material = new THREE.MeshBasicMaterial({ color: 0x0E6655, side: THREE.DoubleSide });
        let leanToRightFrontTrim1 = new THREE.Mesh(leanToRightFrontTrim1Geo, leanToRightFrontTrim1Material);
        ...
        leanToRightFrontTrim1.visible = false;
        const_var.b_t_M_R_t_R.add(leanToRightFrontTrim1);

        let leanToRightFrontTrim2Geo = new THREE.BoxGeometry(0.07 + 0.007, 0.6 + 0.2, 0.2 + 0.1);
        let leanToRightFrontTrim2Material = new THREE.MeshBasicMaterial({ color: 0x0E6655, side: THREE.DoubleSide });
        let leanToRightFrontTrim2 = new THREE.Mesh(leanToRightFrontTrim2Geo, leanToRightFrontTrim2Material);
        ...
        leanToRightFrontTrim2.visible = false;
        const_var.b_t_M_R_t_R.add(leanToRightFrontTrim2);


        let leanToRightFrontTrim3Geo = new THREE.BoxGeometry(0.2 + 0.07, 0.6 + 0.2, 0.2 + 0.1);
        let leanToRightFrontTrim3Material = new THREE.MeshBasicMaterial({ color: 0x0E6655, side: THREE.DoubleSide, });
        let leanToRightFrontTrim3 = new THREE.Mesh(leanToRightFrontTrim3Geo, leanToRightFrontTrim3Material);
        ...
        leanToRightFrontTrim3.visible = false;
        const_var.b_t_M_R_t_R.add(leanToRightFrontTrim3);


        //Trim4 for Right leanto regular in front position
        var leanToRightFrontTrim4Geo = new THREE.BoxGeometry(0.2 + 0.07, 0.6 + 0.2, 0.2 + 0.1);
        var leanToRightFrontTrim4Material = new THREE.MeshBasicMaterial({ color: 0x0E6655, side: THREE.DoubleSide, });
        var leanToRightFrontTrim4 = new THREE.Mesh(leanToRightFrontTrim4Geo, leanToRightFrontTrim4Material);
        leanToRightFrontTrim4.name = "leanToRightFrontTrim4";
        leanToRightFrontTrim4.visible = false; 
        const_var.b_t_M_R_t_R.add(leanToRightFrontTrim4);

        let rightCornerGeo = new THREE.BoxGeometry(0.98, 0.6 + 0.2, 0.2 + 0.1);
        // let rightCornerBowMaterial = new THREE.MeshBasicMaterial({color:0xC9C6C6,side:THREE.DoubleSide});
        let leanToRightFrontCorner = new THREE.Mesh(rightCornerGeo, bowMaterial);
        ...
        leanToRightFrontCorner.visible = false;
        const_var.b_t_M_R_t_R.add(leanToRightFrontCorner);

        let rightCornerGeoR = new THREE.BoxGeometry(0.98, 0.6 + 0.2, 0.2 + 0.1);
        // let rightCornerBowMaterialR = new THREE.MeshBasicMaterial({color:0xC9C6C6,side:THREE.DoubleSide});
        let leanToRightFrontCornerR = new THREE.Mesh(rightCornerGeoR, bowMaterial);
        ...
        leanToRightFrontCornerR.visible = false;
        const_var.b_t_M_R_t_R.add(leanToRightFrontCornerR);


        //Right Leanto Front Trim For A-frame and Vertical
        let trimGeometry = new THREE.BoxGeometry(1, 0.6 + 0.2, 0.2 + 0.1);
        let rightLeanToFrontTrimA = new THREE.Mesh(trimGeometry, trimMaterial);
        rightLeanToFrontTrimA.name = "rightLeanToFrontTrimA";
        rightLeanToFrontTrimA.visible = false; 
        const_var.b_t_M_R_t_R.add(rightLeanToFrontTrimA);

        //Right Leanto Left Trim For A-frame and Vertical
        let leanToleftlegGeo = new THREE.BoxGeometry(0.31 + 0.1, 1 + 0.0015, 0.2 + 0.07);
        let rightLeantoLeftTrimA = new THREE.Mesh(leanToleftlegGeo, trimMaterial);
        rightLeantoLeftTrimA.name = "rightLeantoLeftTrimA";
        rightLeantoLeftTrimA.visible = false; 
        const_var.b_t_M_R_t_R.add(rightLeantoLeftTrimA);

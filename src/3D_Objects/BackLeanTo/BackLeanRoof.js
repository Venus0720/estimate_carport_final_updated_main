...
export default class BackLeanToRoof extends Component {

    createBackLeanToRoof = (const_var,params)=>{
        ...
        let bRoofGeometry1 = new THREE.BufferGeometry();
      ...
      combine:2,shininess:30,
        ...
        let bRoof = new THREE.Mesh( bRoofGeometry1, lRoofmaterial );
        bRoof.name = "bRoof";
        bRoof.visible = false;
    ...
    let verticesT = [
      ...
      let materialT= new THREE.MeshPhongMaterial({ 
        ...
        cubeTFF.name = "leanToRegularRoofB";
        let rCalorB = params.p_r_c.replace("#","0x");
        cubeTFF.material.color.setHex( rCalorB );
        cubeTFF.visible =false;
        const_var.b_t_M_B_t_B.add(cubeTFF);
        ...
        let backLeanToFrontBow = new THREE.Mesh(bowGeometry,bowMaterial);
        ...
        backLeanToFrontBow.visible = false;
        const_var.b_t_M_B_t_B.add(backLeanToFrontBow);

        //Bow for left leanto regular in back position
        let backLeanToFrontBowR = new THREE.Mesh(bowGeometry,bowMaterial);
        ...
        backLeanToFrontBowR.visible = false;
        const_var.b_t_M_B_t_B.add(backLeanToFrontBowR);

        //Trim for left leanto regular in back position
        let backLeanToFrontTrim = new THREE.Mesh(bowGeometry,trimMaterial1);
        ...
        backLeanToFrontTrim.visible = false;
        ...
        //Trim1 for left leanto regular in back position
         ...
         let backLeanToFrontTrim1 = new THREE.Mesh(leanToFrontTrim1Geo,leanToLeftFrontTrim1Material);
        ...
        //  backLeanToFrontTrim1.visible = (params.p_r_s == "1")?true:false; 
         backLeanToFrontTrim1.visible = false; 
         const_var.b_t_M_B_t_B.add(backLeanToFrontTrim1);

          //Trim2 for left leanto regular in back position
          let backLeanToFrontTrim2Geo = new THREE.BoxGeometry(0.07+0.007,0.6+0.2,0.2+0.1);
          let backLeanToFrontTrim2Material = new THREE.MeshBasicMaterial({color:0x0E6655,side:THREE.DoubleSide});
          let backLeanToFrontTrim2 = new THREE.Mesh(backLeanToFrontTrim2Geo,backLeanToFrontTrim2Material);
        ...
        //   backLeanToFrontTrim2.visible = (params.p_r_s == "1")?true:false; 
          backLeanToFrontTrim2.visible = false; 
          const_var.b_t_M_B_t_B.add(backLeanToFrontTrim2);

           //Trim3 for left leanto regular in back position
           let backLeanToFrontTrim3Geo = new THREE.BoxGeometry(0.2+0.07,0.6+0.2,0.2+0.1);
           let leanToLeftFrontTrim3Material = new THREE.MeshBasicMaterial({color:0x0E6655,side:THREE.DoubleSide,});
           let backLeanToFrontTrim3 = new THREE.Mesh(backLeanToFrontTrim3Geo,leanToLeftFrontTrim3Material);
        ...
        //    backLeanToFrontTrim3.visible = (params.p_r_s == "1")?true:false; 
           backLeanToFrontTrim3.visible = false; 
          ...
          let backLeanToFrontBow1 = new THREE.Mesh(leftBowGeo1,bowMaterial);
        ...
        //   backLeanToFrontBow1.visible = (params.p_r_s == "1")?true:false; 
          backLeanToFrontBow1.visible = false; 
          ...
          //Bow2 for left leanto regular in back position
           ...
           let backLeanToFrontBow2 = new THREE.Mesh(leftBowGeo2,bowMaterial);
        ...
        //    backLeanToFrontBow2.visible = (params.p_r_s == "1")?true:false; 
           backLeanToFrontBow2.visible = false; 
          ...
          let backLeanToFrontBow3 = new THREE.Mesh(leftBowGeo3,bowMaterial);
        ...
        //   backLeanToFrontBow3.visible = (params.p_r_s == "1")?true:false; 
          backLeanToFrontBow3.visible = false; 
          ...
          let backLeanToFrontCorner = new THREE.Mesh(leftCornerGeo,bowMaterial);
          ...
          backLeanToFrontCorner.visible = false; 
          ...
          let backLeanToFrontCornerR = new THREE.Mesh(leftCornerRGeo,bowMaterial);
        ...
        //   backLeanToFrontCornerR.visible = (params.p_r_s == "1")?true:false; 
          backLeanToFrontCornerR.visible = false; 
	      ...
	      let backLeanToRightTrimA = new THREE.Mesh(bowGeometry,bowMaterialt);
	      backLeanToRightTrimA.name = "backLeanToRightTrimA";
          backLeanToRightTrimA.scale.set(params.p_w/2,0.3,0.5);	
	      backLeanToRightTrimA.position.set(leanToPosB+0.08-0.08,params.leanB_p_h + leanTohIncB + 0.005,params.leanB_p_d/2);	
	      backLeanToRightTrimA.rotation.z = bowsRotation[params.b_l_t_r_pF];
	      backLeanToRightTrimA.scale.x = params.leanB_p_w + bowsScale[params.b_l_t_r_pF][2*params.leanB_p_w]+0.2;
	      backLeanToRightTrimA.visible =false;
	      const_var.b_t_M_B_t_B.add(backLeanToRightTrimA);

	

	      //Left Leanto Left Trim For A-frame and Vertical
	      let leanTobacklegGeo = new THREE.BoxGeometry(0.31+0.1, 1+0.0015, 0.2+0.07);
	      let backLeantoFrontTrimA = new THREE.Mesh(leanTobacklegGeo,bowMaterialt);
          ...
          backLeantoFrontTrimA.visible = false;
	      const_var.b_t_M_B_t_B.add(backLeantoFrontTrimA);

    ...
    // buildingWallsObject.addWallsIntoBuilding(const_var, params);
        ...
        var roofMiddleHeight = {
          ...
          var f_S_LeanLegScale = {
            ...
            "2":{"6":0.80,"7":0.95,"8":1.1,"9":1.3,"10":1.3,"11":1.6,"12":1.9,"13":2.0,"14":2.2,"15":2.4,"16":2.6,"17":2.9,"18":2.9,"19":3.1,"20":3.2,"21":3.33,"22":3.65,"23":3.9,"24":4.05,"25":2.9,"26":2.9,"27":2.9,"28":2.9,"29":2.9,"30":2.9,},
            "3":{"6":1.40,"7":1.70,"8":2.10,"9":2.27,"10":2.60,"11":2.82,"12":3.10,"13":3.20,"14":3.50,"15":3.70,"16":4.02,"17":4.25,"18":4.30,"19":4.60,"20":4.90,"21":5.20,"22":5.55,"23":5.65,"24":5.95,"25":0.55,"26":0.55,"27":0.60,"28":0.65,"29":0.70,"30":0.75,},
        ...
        var f_S_LeanLegHeight = {
            "1":{"6":0.000,"7":0.050,"8":0.10,"9":0.100,"10":0.100,"11":0.100,"12":0.00,"13":0.00,"14":0.10,"15":0.15,"16":0.20,"17":0.20,"18":0.20,"19":0.20,"20":0.20,"21":0.20,"22":0.20,"23":0.20,"24":0.20,"25":0.20,"26":0.20,"27":0.20,"28":0.20,"29":0.20,"30":0.20,},
            "2":{"6":0.45,"7":0.50,"8":0.60,"9":0.70,"10":0.88,"11":0.90,"12":0.98,"13":1.10,"14":1.15,"15":1.20,"16":1.25,"17":1.32,"18":1.40,"19":1.55,"20":1.65,"21":1.72,"22":1.75,"23":1.80,"24":1.90,"25":1.4,"26":0.30,"27":0.30,"28":0.35,"29":0.35,"30":0.40,},
            "3":{"6":0.72,"7":0.80,"8":0.85,"9":1.00,"10":1.10,"11":1.25,"12":1.35,"13":1.45,"14":1.65,"15":1.80,"16":1.90,"17":2.00,"18":2.20,"19":2.30,"20":2.40,"21":2.50,"22":2.64,"23":2.80,"24":2.90,"25":0.55,"26":0.55,"27":0.60,"28":0.65,"29":0.70,"30":0.75,},
            "4":{"6":0.175,"7":0.200,"8":0.25,"9":0.300,"10":0.350,"11":0.375,"12":0.35,"13":0.35,"14":0.40,"15":0.45,"16":0.50,"17":0.55,"18":0.60,"19":0.65,"20":0.70,"21":0.70,"22":0.75,"23":0.75,"24":0.80,"25":0.85,"26":0.85,"27":0.90,"28":0.95,"29":1.00,"30":1.05,},
            "5":{"6":0.250,"7":0.300,"8":0.35,"9":0.425,"10":0.475,"11":0.525,"12":0.50,"13":0.55,"14":0.60,"15":0.65,"16":0.70,"17":0.75,"18":0.85,"19":0.90,"20":0.95,"21":1.00,"22":1.05,"23":1.10,"24":1.15,"25":1.20,"26":1.25,"27":1.30,"28":1.35,"29":1.40,"30":1.45,},
        ...
        data.forEach(function(a) {
            if (a instanceof THREE.Mesh)
            {
                ...
                if("fGable" == a.name )
                {
                    ...
                    a.geometry.setAttribute( 'uv', new THREE.BufferAttribute( fbGableUVS, 2 ) );
                    ...
                    a.visible = ((params.p_f_w !="Open" || params.add_front_lean) && (params.singleSlope!=true))?true:false;
                    a.scale.set(params.p_w,roofMiddleHeight[params.p_r_p][params.p_w],0);
                    a.position.set(0,params.p_h,params.p_d/2);
                    if(params.p_r_s == "1")
                    {
                        a.position.set(0,params.p_h+0.46,params.p_d/2);
                        a.scale.set(params.p_w-0.25,roofMiddleHeight[params.p_r_p][params.p_w],0);
                    }
                    a.material.map = texture1;
                    a.material.map.wrapS = THREE.RepeatWrapping;
                    a.material.map.wrapT = THREE.RepeatWrapping;	
                    if(params.p_v_w==true)
                    {
                        a.material.map.repeat.set(params.p_w-2,1);
                    }
                    else
                    {
                        a.material.map.repeat.set(1,roofMiddleHeight[params.p_r_p][params.p_w]/4);
                    }
                }

                /*Center Building Right Storage Front Gable*/
              if("CB_R_S_F_G" == a.name) {
                if(params.p_v_w==true) {
                ...
                var cBRightStorageFGableVertices = new Float32Array([
                    //left
                    params.p_w/2-params.cB_addStorage_right, params.p_h, params.p_d/2,
                    //right
                    params.p_w/2, params.p_h, params.p_d/2,
                     //top
                     params.p_w/2-params.cB_addStorage_right,params.p_h+(params.cB_addStorage_right*(params.p_r_p/12)), params.p_d/2,
                  ]);
                }else{
                    var cBRightStorageFGableVertices = new Float32Array([
                     //left
                     ...
                     params.p_w/2, params.p_h, params.p_d/2,
                      //top
                      0,params.p_h+roofMiddleHeight[params.p_r_p][params.p_w], params.p_d/2,
                    ]);
                }
                a.geometry.setAttribute("position", new THREE.BufferAttribute(cBRightStorageFGableVertices, 3));
                a.geometry.setAttribute( 'uv', new THREE.BufferAttribute( cBRightStorageFGableUVS, 2 ) );
                a.visible = (params.cB_addStorage_check_right!=false)?true:false;
                ...
                a.material.map.repeat.set(params.p_w-2,1);
                    ...
                    if(params.cB_addStorage_right < params.p_w/2){
                a.material.map.repeat.set(1,roofMiddleHeight[params.p_r_p][2*params.p_w]/(10.75-(params.cB_addStorage_right*0.75)));
                    }else{
                        a.material.map.repeat.set(1,roofMiddleHeight[params.p_r_p][2*params.p_w]/4)
                    }
              }
            }

            /*Center Building Left Storage Front Gable*/
            if("CB_L_S_F_G" == a.name) {
                if(params.p_v_w==true) {
                ...
                var cBLeftStorageFGableVertices = new Float32Array([
                    //left
                    -(params.p_w/2-params.cB_addStorage_left), params.p_h, params.p_d/2,
                    //right
                    params.p_w/-2, params.p_h, params.p_d/2,
                     //top
                     -(params.p_w/2-params.cB_addStorage_left),params.p_h+(params.cB_addStorage_left*(params.p_r_p/12)), params.p_d/2,
                  ]);
                }else{
                    var cBLeftStorageFGableVertices = new Float32Array([
                     //left
                ...
                a.geometry.setAttribute("position", new THREE.BufferAttribute(cBLeftStorageFGableVertices, 3));
                a.geometry.setAttribute( 'uv', new THREE.BufferAttribute( cBLeftStorageFGableUVS, 2 ) );
                a.visible = (params.cB_addStorage_check_left!=false)?true:false;
                a.material.map = FWtexture;
                a.material.map.wrapS = THREE.RepeatWrapping;
                a.material.map.wrapT = THREE.RepeatWrapping;	
                if(params.p_v_w==true){
                a.material.map.repeat.set(params.p_w-2,1);
                    ...
                    if(params.cB_addStorage_left < params.p_w/2){
                a.material.map.repeat.set(1,roofMiddleHeight[params.p_r_p][2*params.p_w]/(10.75-(params.cB_addStorage_left*0.75)));
                    }else{
                        a.material.map.repeat.set(1,roofMiddleHeight[params.p_r_p][2*params.p_w]/4)
                    }
              }
            ...
            if("CB_L_S_B_G" == a.name) {
                ...
                a.geometry.setAttribute("position", new THREE.BufferAttribute(cBLeftStorageBGableVertices, 3));
                a.geometry.setAttribute( 'uv', new THREE.BufferAttribute( cBLeftStorageBGableUVS, 2 ) );
                a.visible = (params.cB_addStorage_check_left!=false)?true:false;
                a.material.map = FWtexture;
                a.material.map.wrapS = THREE.RepeatWrapping;
                a.material.map.wrapT = THREE.RepeatWrapping;	
            ...
            /*Center Building Right Storage Back Gable*/
            if("CB_R_S_B_G" == a.name) {
                var rtFwallPos = params.p_w/2 + params.p_w/2;
                if(params.p_v_w==true) {
                ...
                a.geometry.setAttribute("position", new THREE.BufferAttribute(cBRightStorageBGableVertices, 3));
                a.geometry.setAttribute( 'uv', new THREE.BufferAttribute( cBRightStorageBGableUVS, 2 ) );
                a.visible = (params.cB_addStorage_check_right!=false)?true:false;
                a.material.map = FWtexture;
                a.material.map.wrapS = THREE.RepeatWrapping;
                a.material.map.wrapT = THREE.RepeatWrapping;	
            ...
            var selectedObject = const_var.scene.getObjectByName("CB_R_S_4V_F_G");
            if(selectedObject != undefined)
            {
                ...
                [
                  //botom left
                    ...
                    0,-0,0,
                    //top right
                    0,roofMiddleHeight[params.p_r_p][params.p_w],0,
                    //top left
                    x_verticesPos,roofMiddleHeight[params.p_r_p][params.p_w]-((params.cB_addStorage_right-(params.p_w/2))*((params.p_r_p/10)-(params.p_r_p/100+0.02))),0,
                ...
                const_var.scene.getObjectByName("CB_R_S_4V_F_G").geometry.setAttribute( 'uv', new THREE.BufferAttribute( cBRightStorageFGableUVS, 2 ) );
                const_var.scene.getObjectByName("CB_R_S_4V_F_G").geometry.setAttribute( 'position', new THREE.BufferAttribute( vertices, 3 ) );
                const_var.scene.getObjectByName("CB_R_S_4V_F_G").scale.set(1,1,1);
                const_var.scene.getObjectByName("CB_R_S_4V_F_G").position.set(0,params.p_h,params.p_d/2);
                 const_var.scene.getObjectByName("CB_R_S_4V_F_G").visible =(params.cB_addStorage_check_right!=false)?true:false;
                if(params.p_v_w==true){
                    const_var.scene.getObjectByName("CB_R_S_4V_F_G").material.map.repeat.set(params.p_w-2,1);
                    } else {
                        if(params.cB_addStorage_right < params.p_w/2){
                            const_var.scene.getObjectByName("CB_R_S_4V_F_G").material.map.repeat.set(1,roofMiddleHeight[params.p_r_p][2*params.p_w]/(10.75-(params.cB_addStorage_right*0.75)));
                        }else{
                            const_var.scene.getObjectByName("CB_R_S_4V_F_G").material.map.repeat.set(1,roofMiddleHeight[params.p_r_p][2*params.p_w]/4)
                        }
                  }
            }
            ...
            var selectedObject = const_var.scene.getObjectByName("CB_L_S_4V_F_G");
            if(selectedObject != undefined)
            {
                var x_verticesPos = 0;
                if(params.cB_addStorage_left > params.p_w/2)
                ...
                var anand = params.cB_addStorage_left.toString().split('')
                var quad_vertices =
                [
                  //botom left
                     x_verticesPos,-0,0,
                    ...
                    0,roofMiddleHeight[params.p_r_p][params.p_w],0,
                    //top left
                    x_verticesPos,roofMiddleHeight[params.p_r_p][params.p_w]-((params.cB_addStorage_left-(params.p_w/2))*((params.p_r_p/10)-(params.p_r_p/100+0.02))),0,
                ...
                const_var.scene.getObjectByName("CB_L_S_4V_F_G").geometry.setAttribute( 'uv', new THREE.BufferAttribute( cBRightStorageFGableUVS, 2 ) );

                const_var.scene.getObjectByName("CB_L_S_4V_F_G").geometry.setAttribute( 'position', new THREE.BufferAttribute( vertices, 3 ) );
                const_var.scene.getObjectByName("CB_L_S_4V_F_G").scale.set(1,1,1);
                const_var.scene.getObjectByName("CB_L_S_4V_F_G").position.set(0,params.p_h,params.p_d/2);
                 const_var.scene.getObjectByName("CB_L_S_4V_F_G").visible =(params.cB_addStorage_check_left!=false)?true:false;
                 if(params.p_v_w==true){
                    const_var.scene.getObjectByName("CB_L_S_4V_F_G").material.map.repeat.set(params.p_w-2,1);
                    } else {
                        if(params.cB_addStorage_left < params.p_w/2){
                            const_var.scene.getObjectByName("CB_L_S_4V_F_G").material.map.repeat.set(1,roofMiddleHeight[params.p_r_p][2*params.p_w]/(10.75-(params.cB_addStorage_left*0.75)));
                        }else{
                            const_var.scene.getObjectByName("CB_L_S_4V_F_G").material.map.repeat.set(1,roofMiddleHeight[params.p_r_p][2*params.p_w]/4)
                        }
                  }
            }
            ...
            var selectedObject = const_var.scene.getObjectByName("CB_L_S_4V_B_G");
            if(selectedObject != undefined)
            {
                var x_verticesPos = 0;
                if(params.cB_addStorage_left > params.p_w/2)
                ...
                const_var.scene.getObjectByName("CB_L_S_4V_B_G").geometry.setAttribute( 'uv', new THREE.BufferAttribute( cBRightStorageBGableUVS, 2 ) );

                const_var.scene.getObjectByName("CB_L_S_4V_B_G").geometry.setAttribute( 'position', new THREE.BufferAttribute( vertices, 3 ) );
                const_var.scene.getObjectByName("CB_L_S_4V_B_G").scale.set(1,1,1);
                const_var.scene.getObjectByName("CB_L_S_4V_B_G").position.set(0,params.p_h,params.p_d/-2);
                 const_var.scene.getObjectByName("CB_L_S_4V_B_G").visible =(params.cB_addStorage_check_left!=false)?true:false;
                 if(params.p_v_w==true){
                    const_var.scene.getObjectByName("CB_L_S_4V_B_G").material.map.repeat.set(params.p_w-2,1);
                    } else {
                        if(params.cB_addStorage_left < params.p_w/2){
                            const_var.scene.getObjectByName("CB_L_S_4V_B_G").material.map.repeat.set(1,roofMiddleHeight[params.p_r_p][2*params.p_w]/(10.75-(params.cB_addStorage_left*0.75)));
                        }else{
                            const_var.scene.getObjectByName("CB_L_S_4V_B_G").material.map.repeat.set(1,roofMiddleHeight[params.p_r_p][2*params.p_w]/4)
                        }
                  }
            }
            ...
            var selectedObject = const_var.scene.getObjectByName("CB_R_S_4V_B_G");
            if(selectedObject != undefined)
            {
                var x_verticesPos = 0;
                if(params.cB_addStorage_right > params.p_w/2)
                ...
                var anand = params.cB_addStorage_right.toString().split('')
                var quadB_vertices =
                [
                  //botom left
                     x_verticesPos,-0,0,
                ...
                const_var.scene.getObjectByName("CB_R_S_4V_B_G").geometry.setAttribute( 'uv', new THREE.BufferAttribute( cBRightStorageBGableUVS, 2 ) );

                const_var.scene.getObjectByName("CB_R_S_4V_B_G").geometry.setAttribute( 'position', new THREE.BufferAttribute( verticesB, 3 ) );
                const_var.scene.getObjectByName("CB_R_S_4V_B_G").scale.set(1,1,1);
                const_var.scene.getObjectByName("CB_R_S_4V_B_G").position.set(0,params.p_h,params.p_d/-2);
                const_var.scene.getObjectByName("CB_R_S_4V_B_G").visible =(params.cB_addStorage_check_right!=false)?true:false;
                if(params.p_v_w==true){
                    const_var.scene.getObjectByName("CB_R_S_4V_B_G").material.map.repeat.set(params.p_w-2,1);
                } else {
                  if(params.cB_addStorage_right < params.p_w/2) {
                      const_var.scene.getObjectByName("CB_R_S_4V_B_G").material.map.repeat.set(1,roofMiddleHeight[params.p_r_p][2*params.p_w]/(10.75-(params.cB_addStorage_right*0.75)));
                  } else {
                      const_var.scene.getObjectByName("CB_R_S_4V_B_G").material.map.repeat.set(1,roofMiddleHeight[params.p_r_p][2*params.p_w]/4)
                  }
                }
            }


                //New Geo For Front storage Gable
                if("f_S_Gable" == a.name )
                {
                    if(params.p_v_w==true)
                    {
                    ...
                    a.geometry.setAttribute( 'uv', new THREE.BufferAttribute( f_S_GableUVS, 2 ) );
                    var f_S_GableLoader = new THREE.TextureLoader();
                    var texture1 = f_S_GableLoader.load(
                        wallTexture,
                         function(texture1) {
                       texture1.wrapS = THREE.RepeatWrapping;
                       texture1.wrapT = THREE.RepeatWrapping;
                       ...
                       a.scale.set(params.p_w,roofMiddleHeight[params.p_r_p][params.p_w],0);
                       a.position.set(0,params.p_h,leng+storagePos[params.p_u_t]);
                       a.visible = (params.p_u_c!=false && (params.singleSlope!=true))?true:false;
                       ...
                       {
                           a.position.set(0,params.p_h,leng+storagePos[params.p_u_t]);
                           a.scale.set(params.p_w,roofMiddleHeight[params.p_r_p][params.p_w]+0.5,0);
                       }	
                       if(params.p_v_w==true)
                       {
                           a.material.map.repeat.set(params.p_w-2,1);
                ...
                if("bGable" == a.name )
                {
                    ...
                    a.visible = ((params.p_b_w !="Open" || params.add_back_lean || params.p_u_c!=false) && (params.singleSlope!=true) )?true:false;  
                    ////a.scale.set(params.p_w,params.p_r_p,0);
                    a.scale.set(params.p_w,roofMiddleHeight[params.p_r_p][params.p_w],0);
                    a.position.set(0,params.p_h,params.p_d/-2);
                    if(params.p_r_s == "1")
                    {
                        a.position.set(0,params.p_h+0.32+0.1,params.p_d/-2);
                        a.scale.set(params.p_w-0.2,roofMiddleHeight[params.p_r_p][params.p_w],0);
                    }
                    a.material.map = texture1;
                    a.material.map.wrapS = THREE.RepeatWrapping;
                    a.material.map.wrapT = THREE.RepeatWrapping;	
                ...
                /*Free Standing LeanTo Front Gable */
                if("F_S_L_F_G" == a.name )
                {
                    if(params.p_v_w==true)
                    {
                    ...
                    a.geometry.setAttribute( 'uv', new THREE.BufferAttribute( f_S_LeanFrontGableUVS, 2 ) );
                    a.visible = (params.p_f_w !="Open" && params.singleSlope)?true:false;;  
                    a.scale.set(params.p_w - 0.20, f_S_LeanLegScale[params.p_r_p][params.p_w],0);
                    a.position.set(0,params.p_h-0.09,params.p_d/2);
                    a.material.map = FWtexture;
                    a.material.map.wrapS = THREE.RepeatWrapping;
                    a.material.map.wrapT = THREE.RepeatWrapping;	
                    if(params.p_v_w==true) {
                ...
                /*Free Standing LeanTo Back Gable */
                if("F_S_L_B_G" == a.name )
                {
                    if(params.p_v_w==true)
                    {
                    ...
                    a.geometry.setAttribute( 'uv', new THREE.BufferAttribute( f_S_LeanBackGableUVS, 2 ) );
                    a.visible = ((params.p_b_w !="Open" || params.p_u_c!=false) && params.singleSlope)?true:false; 
                    a.scale.set(params.p_w-0.20,f_S_LeanLegScale[params.p_r_p][params.p_w],0);
                    a.position.set(0,params.p_h-0.09,params.p_d/-2);
                    a.material.map = FWtexture;
                    a.material.map.wrapS = THREE.RepeatWrapping;
                ...
                /*Free Standing LeanTo Front Storage Gable */
                if("F_S_L_F_S_G" == a.name )
                {
                    if(params.p_v_w==true)
                    {
                    ...
                    a.geometry.setAttribute( 'uv', new THREE.BufferAttribute( f_S_LeanToFrontStorageGableUVS, 2 ) );
                    a.visible = ((params.p_b_w !="Open" || params.p_u_c!=false) && params.singleSlope)?true:false;  
                    a.visible = ( params.p_u_c!=false && params.singleSlope)?true:false;  
                    a.scale.set(params.p_w -0.20,f_S_LeanLegScale[params.p_r_p][params.p_w],0);
                    a.position.set(0,params.p_h-0.09,leng+storagePos[params.p_u_t]);
                    a.material.map = FWtexture;
                    a.material.map.wrapS = THREE.RepeatWrapping;
                    a.material.map.wrapT = THREE.RepeatWrapping;	
                    if(params.p_v_w==true)
                ...
                /*Front Wall */
                if("c_b_g_p_new" == a.name )
                {	
                    a.visible = (params.p_f_w !="OPen")?true:false;

                    a.position.x = 0;
                    a.position.z = params.p_d / 2;						
                    /*var frontWallLoader = new THREE.TextureLoader();
                    var FWtexture = frontWallLoader.load(wallTexture, function() {
                        FWtexture.anisotropy = Math.min(const_var.renderer.capabilities.getMaxAnisotropy(), 5);
                        FWtexture.wrapS = THREE.RepeatWrapping;
                    ...
                    var testtexture = test.load(wallTexture, function() {
                        testtexture.anisotropy = Math.min(const_var.renderer.capabilities.getMaxAnisotropy(), 5);
                    ...
                    a.position.y = wP;				
                    a.scale.set(params.p_w-0.20,wH,0);
                    ...
                    switch(params.p_f_w)
                    {
                        ...
                        case "Close":
                            ...
                            break;
                        default:
                            var hdfp = params.p_h - (params.lean_p_h + Number(params.b_l_t_r_pF));
                    ...
                    if(params.p_r_s == "1")
                    {
                       ...
                       switch(params.p_f_w)
                       {
                        ...
                        a.position.y = wP+0.09;				
                    a.scale.set(params.p_w-0.28,wH,0);
                    }
                    ...
                    {
                        //a.material.map.repeat.set(1,params.p_h/3);
                        ////a.material.map.repeat.set(1,wH/3);
                        ////Last
                        ////a.material.map.repeat.set(1,wH);
                        a.material.map.repeat.set(1,wH/4);
                        //a.material.envMap.repeat.set(1,wH/4);
                        //a.material.combine = THREE.MultiplyOperation;
                    }
                    // console.log(a,const_var.renderer.capabilities.getMaxAnisotropy());
                }
                /*Front storage Wall*/
                if("c_b_g_f_s" == a.name )
                    {
                        a.scale.set(params.p_w,params.p_h,0);
                        a.scale.x = (params.singleSlope)? params.p_w-0.10: params.p_w
                        a.position.x = (params.singleSlope)? -0.05 : 0;

                        a.position.y =  params.p_h/2
                        a.position.z = leng+storagePos[params.p_u_t];
                        a.visible = (params.p_u_c!=false)?true:false;
                    ...
                    if("c_b_r_s_f_w" == a.name )
                    {	
                        a.visible = (params.cB_addStorage_check_right!=false)?true:false;
    
                        a.position.x = params.p_w/2-params.cB_addStorage_right/2;
                        a.position.y = params.p_h/2;
                        a.position.z = params.p_d / 2;	
                        a.scale.set(params.cB_addStorage_right,params.p_h,0);					
                        a.material.envMap = FWtexture;
                        a.material.emissiveMap = FWtexture;
                        a.material.emissiveIntensity = 1;
                        a.material.map = FWtexture;
                    ...
                    if("c_b_l_s_f_w" == a.name )
                    {	
                        a.visible = (params.cB_addStorage_check_left!=false)?true:false;
    
                        a.position.x = -(params.p_w/2-params.cB_addStorage_left/2);
                        a.position.y = params.p_h/2;
                        a.position.z = params.p_d / 2;	
                        a.scale.set(params.cB_addStorage_left,params.p_h,0);					
                        a.material.envMap = FWtexture;
                        a.material.emissiveMap = FWtexture;
                        a.material.emissiveIntensity = 1;
                        a.material.map = FWtexture;
                    ...
                    // console.log(params.p_u_t,params.p_u_c,  initialState.params.p_u_f_w,"params.add_storage")
                if("c_b_g_p_new_w" == a.name )
                {
                    a.visible = (params.p_f_w !="Open" && params.p_w_c_n == true)?true:false;
                    a.position.x = 0;
                    a.position.z = params.p_d / 2 + 0.01;
                    a.position.y = 1.5;				
                    a.scale.set(params.p_w,3,0);
                    ...
                    var FWtexture = frontWallLoader.load(wallTexture, function() {
                        ...
                        FWtexture.wrapS = THREE.RepeatWrapping;
                        FWtexture.wrapT = THREE.RepeatWrapping;
                        FWtexture.magFilter = THREE.NearestFilter;
                    });*/				
                    a.material.map = FWtexture;
                    a.material.map.wrapS = THREE.RepeatWrapping;
                    a.material.map.wrapT = THREE.RepeatWrapping;
                    ...
                    {
                        ////a.material.map.repeat.set(1,3/3);
                        ////Last
                        ////a.material.map.repeat.set(1,3);
                        a.material.map.repeat.set(1,3/4);
                    }
                    //console.log(a,const_var.renderer.capabilities.getMaxAnisotropy());
                }
                /* Left Wall */
                if("c_b_g_l_new" == a.name )
                {
                    params.p_l_w = ( params.cB_addStorage_check_left==true && params.p_l_w=="Open")?"Close":params.p_l_w;
                    a.visible = (params.p_l_w !="Open" || params.cB_addStorage_check_left==true)?true:false;
                    // a.visible = (params.p_l_w !="Open")?true:false;
                    ...
                    switch(params.p_l_w)
                    {
                        ...
                        case "Close":
                            ...
                            break;
                        default:
                                var hdfp = params.p_h - (params.lean_p_h + Number(params.b_l_t_r_p));
                                if(params.add_left_lean && hdfp > 0 && params.a_c_p_l == false )
                                {    
                                    wH = hdfp;
                                    wP = params.p_h - wH/2;
                                    a.visible = true; 
                ...
                {
                    a.visible = (params.p_u_c!=false)?true:false;
                    a.scale.set(storagePos[params.p_u_t],params.p_h,0)
                    a.position.x = params.p_w /-2;
                    a.position.z = (params.p_d/-2)+storagePos[params.p_u_t]/2;
                    a.position.y = params.p_h/2; 
                    a.material.envMap = FWtexture;
                    a.material.emissiveMap = FWtexture;
                    a.material.emissiveIntensity = 1;
                ...
                if("c_b_r_s_l_w" == a.name )
                {
                    a.visible = (params.cB_addStorage_check_right!=false)?true:false;
                    a.position.x = params.p_w /2-params.cB_addStorage_right;
                    a.position.z = 0;
                  
                    // a.scale.set(params.p_d,params.p_h+((updatedCal*params.cB_addStorage_right)-(params.cB_addStorage_right/10)),0);
                    // a.position.y = params.p_h/2 +((updatedCal*params.cB_addStorage_right)/2-((params.cB_addStorage_right/10)/2)); 
                            // a.scale.y = params.p_h;
                        // a.position.y = params.p_h/2; 
                    if(params.cB_addStorage_right <= params.p_w /2){
                        // a.scale.set(params.p_d,params.p_h+(updatedCal*params.cB_addStorage_right)-(params.cB_addStorage_right/21),0);
                        // a.position.y = (params.p_h +(updatedCal*params.cB_addStorage_right)-(params.cB_addStorage_right/21))/2; 
                        a.scale.set(params.p_d,0,0);
                        a.scale.y = params.p_h+(params.cB_addStorage_right*(roofMiddleHeight[params.p_r_p][params.p_w]/(params.p_w/2)))
                        a.position.y = (params.p_h+(params.cB_addStorage_right*(roofMiddleHeight[params.p_r_p][params.p_w]/(params.p_w/2))))/2; 
                    } else {
                        let newCalL = (params.p_w /2);
                        let updatedCalL = params.p_r_p/newCalL;
                        a.scale.set(params.p_d,0,0);
                        a.scale.y = (params.p_h+(roofMiddleHeight[params.p_r_p][params.p_w]))-((params.cB_addStorage_right-(params.p_w/2))*(params.p_r_p/12));
                        a.position.y = (((params.p_h+(roofMiddleHeight[params.p_r_p][params.p_w]))-((params.cB_addStorage_right-(params.p_w/2))*(params.p_r_p/12)))/2); 
                    }
                ...
                if("c_b_l_s_r_w" == a.name )
                {
                    a.visible = (params.cB_addStorage_check_left!=false)?true:false;
                    a.position.x = -(params.p_w/2-params.cB_addStorage_left);
                    // console.log(a.position.x,"anand1234")
                    a.position.z = 0;
 
                    if(params.cB_addStorage_left <= params.p_w /2){
                       
                        a.scale.set(params.p_d,0,0);
                        a.scale.y = params.p_h+(params.cB_addStorage_left*(roofMiddleHeight[params.p_r_p][params.p_w]/(params.p_w/2)))
                        a.position.y = (params.p_h+(params.cB_addStorage_left*(roofMiddleHeight[params.p_r_p][params.p_w]/(params.p_w/2))))/2; 
                    } else {
                        let newCalL = (params.p_w /2);
                        let updatedCalL = params.p_r_p/newCalL;
                        a.scale.set(params.p_d,0,0);
                        a.scale.y = (params.p_h+(roofMiddleHeight[params.p_r_p][params.p_w]))-((params.cB_addStorage_left-(params.p_w/2))*(params.p_r_p/12));
                        a.position.y = (((params.p_h+(roofMiddleHeight[params.p_r_p][params.p_w]))-((params.cB_addStorage_left-(params.p_w/2))*(params.p_r_p/12)))/2); 
                    }
                ...
                if("c_b_g_l_new_w" == a.name )
                {
                    a.visible = (params.p_l_w !="Open" && params.p_w_c_n == true)?true:false;
                    a.position.x = params.p_w / -2 - 0.01;
                    a.position.z = 0;
                    a.position.y = 1.5;				
                    a.scale.set(params.p_d,3,0);				
                    /*var frontWallLoaderW = new THREE.TextureLoader();
                    var FWtextureW = frontWallLoaderW.load(wallTexture, function() {
                        FWtextureW.anisotropy = Math.min(const_var.renderer.capabilities.getMaxAnisotropy(), 5);
                        FWtextureW.wrapS = THREE.RepeatWrapping;
                        FWtextureW.wrapT = THREE.RepeatWrapping;
                    });
                    a.material.map = FWtextureW;*/
                    a.material.map = FWtexture;
                    a.material.map.wrapS = THREE.RepeatWrapping;
                    a.material.map.wrapT = THREE.RepeatWrapping;
                    a.material.map.offset.x = params.p_w;
                ...
                /* Right Wall */
                if("c_b_g_r_new" == a.name )
                {
                    params.p_r_w = ( params.cB_addStorage_check_right==true && params.p_r_w=="Open")?"Close":params.p_r_w;
                    a.visible = ((params.p_r_w !="Open" || params.cB_addStorage_check_right==true )&& (params.singleSlope!=true))?true:false;
                    a.position.x = params.p_w / 2;
                    a.position.z = 0;
                    //a.position.y = params.p_h / 2;				
                    ...
                    switch(params.p_r_w)
                    {
                        ...
                        case "Close":
                            ...
                            break;
                        default:
                                var hdfp = params.p_h - (params.leanR_p_h + Number(params.b_l_t_r_pR));
                                if(params.add_right_lean && hdfp > 0 && params.a_c_p_r == false )
                                {    
                                    wH = hdfp;
                                    wP = params.p_h - wH/2;
                                    a.visible = true;
                ...
                /* Free Sranding Lean TO Right Wall */
                if("F_S_L_R_W" == a.name )
                {
                    a.visible = (params.p_r_w != "Open"&& params.singleSlope )?true:false;
                    a.material.envMap = FWtexture;
                    a.material.emissiveMap = FWtexture;
                    a.material.emissiveIntensity = 1;
                    a.material.map = FWtexture;
                    ...
                    a.position.set(params.p_w / 2 -0.1, wP, 0);			
                    a.scale.set(params.p_d, wH , 0);
                    ...
                    switch(params.p_r_w)
                    {
                        ...
                        case "Gable":
                            break;
                        case "Close":
                            wH = params.p_h+2*f_S_LeanLegHeight[params.p_r_p][params.p_w];
                            wP = params.p_h+2*f_S_LeanLegHeight[params.p_r_p][params.p_w] - wH/2;
                            break;
                        default:
                            wH = Math.abs(params.p_r_w.replace(/\D/g, "")) * 3;
                ...
                /* Right storage Wall &&  Free Sranding Lean TO Right Storage Wall*/
                if("c_b_g_r_s_w" == a.name )
                {
                    var wH = params.p_h+2*f_S_LeanLegHeight[params.p_r_p][params.p_w];
                    var wP =  params.p_h+2*f_S_LeanLegHeight[params.p_r_p][params.p_w] - wH/2;
                    a.visible = (params.p_u_c!=false)?true:false;
                    a.scale.set(storagePos[params.p_u_t],params.p_h,0)
                    a.scale.y = (params.singleSlope)? wH : params.p_h
                    a.position.x =(params.singleSlope)? params.p_w /2-0.1:params.p_w /2;
                    a.position.z = (params.p_d/-2)+storagePos[params.p_u_t]/2;
                    a.position.y = (params.singleSlope)? wP:params.p_h/2; 
                    a.material.envMap = FWtexture;
                    a.material.emissiveMap = FWtexture;
                    a.material.emissiveIntensity = 1;
                    a.material.map = FWtexture;
                 ...
                 /* Right Wall Wainscot */
                if("c_b_g_r_new_w" == a.name )
                {
                    a.visible = (params.p_r_w !="Open" && params.p_w_c_n == true)?true:false;
                    a.position.x = params.p_w / 2 + 0.01;
                    a.position.z = 0;
                    a.position.y = 1.5;				
                    a.scale.set(params.p_d,3,0);
                ...
                /* BackWall */
                if("c_b_g_b_new" == a.name )
                {
                    a.visible = (params.p_b_w !="Open")?true:false;
                    a.position.x = 0;
                    a.position.z = params.p_d / -2;
                    ...
                    switch(params.p_b_w)
                    {
                        ...
                        case "Close":
                            ...
                            break;
                        default:
                            var hdfp = params.p_h - (params.lean_p_h + Number(params.b_l_t_r_pB));
                ...
                if("c_b_g_b_s" == a.name )
                {
                    a.visible = (params.p_u_c==true)?true:false;
                    ...
                    a.position.y = params.p_h/2;
                    a.position.z = params.p_d / -2;
                    a.scale.set(params.p_w-0.20,params.p_h,0);
                    a.scale.x = (params.singleSlope)? params.p_w-0.10 : params.p_w;
                    ...
                    if(params.p_r_s == "1")
                    {		
                        a.position.y = (params.p_h - params.p_h/2)+0.15;				
                        a.scale.set(params.p_w,(params.p_h)+0.55,0);	
                    }
                    // console.log(a);
                }

                if("c_b_r_s_b_w" == a.name )
                {	
                    a.visible = (params.cB_addStorage_check_right!=false)?true:false;
                ...
                if("c_b_g_b_new_w" == a.name )
                {
                    a.visible = (params.p_b_w !="Open" && params.p_w_c_n == true)?true:false;
                    a.position.x = 0;
                    a.position.z = params.p_d / -2 - 0.01;
                    a.position.y = 1.5;
                    a.scale.set(params.p_w,3,0);
        ...
        //     })
        //     }
            //AddLegs And Roof chnages than pass True and Call this Function
            // if(Val)
            // {
            //     addLegs();
        //     rPP();
